...
const ABOUT_IMAGE = "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?q=80&w=1974&auto=format&fit=crop";
...
export default function Home() {
  ...
  const displayServices = services?.length ? services : [
    { 
      ...
      description: "Técnica artesanal para remover amassados sem danificar a pintura original do veículo. Ideal para chuva de granizo e pequenas colisões.", 
      imageUrl: "https://images.unsplash.com/photo-1618585675271-4a37651a2579?q=80&w=2070&auto=format&fit=crop" 
    },
    { 
      id: 2, 
      title: "Polimento Técnico", 
      description: "Correção da pintura removendo riscos superficiais, manchas e hologramas, devolvendo o brilho intenso e profundidade de cor.", 
      imageUrl: "https://images.unsplash.com/photo-1552857497-6953dc5d862f?q=80&w=1974&auto=format&fit=crop" 
    },
    { 
      id: 3, 
      title: "Vitrificação", 
      description: "Proteção cerâmica de alta durabilidade que cria uma barreira contra agentes externos, facilitando a limpeza e mantendo o brilho.", 
      imageUrl: "https://images.unsplash.com/photo-1562916174-a6f67137f88f?q=80&w=2070&auto=format&fit=crop" 
    },
    {
      id: 4,
      title: "Higienização Interna",
      description: "Limpeza profunda e detalhada de bancos, carpetes e painéis, eliminando ácaros, fungos e odores desagradáveis.",
      imageUrl: "https://images.unsplash.com/photo-1605218427360-179267df8c1d?q=80&w=1932&auto=format&fit=crop"
    }
  ];

  const displayPartners = partners?.length ? partners : [
    { id: 1, name: "3M", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/3M_wordmark.svg/2560px-3M_wordmark.svg.png", website: "#" },
    { id: 2, name: "Meguiar's", logoUrl: "https://1000logos.net/wp-content/uploads/2021/10/Meguiars-Logo.png", website: "#" },
    { id: 3, name: "Vonixx", logoUrl: "https://logodownload.org/wp-content/uploads/2022/08/vonixx-logo-1.png", website: "#" },
    { id: 4, name: "Mothers", logoUrl: "https://seeklogo.com/images/M/Mothers_Polishes-logo-71D67B6F30-seeklogo.com.png", website: "#" },
  ];
        ...
        >
          ...
          >
            ...
            <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-light">
              Restauramos a perfeição original do seu veículo com técnicas artesanais de precisão e produtos de classe mundial.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative z-10 border-4 border-white/5 rounded-lg overflow-hidden shadow-2xl shadow-black/50">
                <img src={ABOUT_IMAGE} alt="Automan Team" className="w-full h-auto object-cover grayscale hover:grayscale-0 transition-all duration-700" />
              </div>
              {/* Decorative square */}
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h4 className="text-primary font-bold tracking-widest uppercase mb-4">Quem Somos</h4>
              <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-6">
                Excelência em Cada Detalhe
              </h2>
              <p className="text-gray-400 text-lg leading-relaxed mb-6">
                A Automan nasceu da paixão por automóveis e da busca incessante pela perfeição. Com mais de 10 anos de experiência, nos especializamos na arte do Martelinho de Ouro, recuperando a lataria do seu veículo sem a necessidade de repintura.
              </p>
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                Nossa oficina conta com infraestrutura de ponta e uma equipe certificada, pronta para atender os clientes mais exigentes que não abrem mão da originalidade de seus carros.
              </p>
             ...
             >
              <CarouselContent className="-ml-4 md:-ml-8">
                {displayPartners.map((partner) => (
                  <CarouselItem key={partner.id} className="pl-4 md:pl-8 basis-1/2 md:basis-1/4">
      ...
      <section id="location" className="relative py-0 bg-background">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
          ...
          <div className="relative h-[400px] lg:h-auto w-full bg-secondary">
             <iframe 
               src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3657.197587029676!2d-46.652195685022134!3d-23.561349584682855!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce59c8da0aa315%3A0xd59f9431f2c9776a!2sAv.%20Paulista%2C%20S%C3%A3o%20Paulo%20-%20SP!5e0!3m2!1sen!2sbr!4v1620000000000!5m2!1sen!2sbr" 
               width="100%" 
               height="100%" 
             ...
             <div className="absolute top-8 left-8 bg-white text-black p-6 rounded shadow-xl max-w-xs">
               <h3 className="font-bold text-xl mb-2 flex items-center gap-2">
                 <MapPin className="text-primary w-5 h-5" /> Automan
               </h3>
          ...
          {/* Contact Form Side */}
          <div id="contact" className="relative bg-secondary/10 p-8 lg:p-20 flex flex-col justify-center">
            {/* Background pattern */}
            ...
            <div className="relative z-10 max-w-lg mx-auto w-full">
              <h4 className="text-primary font-bold tracking-widest uppercase mb-2">Fale Conosco</h4>
